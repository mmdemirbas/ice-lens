...
class CardHeightTest {
     ...
     */
    private fun paimonGraphs(): List<Pair<String, GraphModel>> = listOf("test", "dv", "cl", "tg", "pt", "ao", "br", "cs", "fi", "ep", "rt", "sm", "se", "de", "lk", "ad").map { name ->
    ...
    private companion object {
        ...
        val ICEBERG_FIXTURES = listOf(
            "test", "parted", "mor", "eqdel", "v3", "evolved", "respec", "branched", "stats", "branched3", "expired", "maint", "v1", "extdata", "sorted", "promoted", "lineage", "pstats", "wap", "rolled",
        )
