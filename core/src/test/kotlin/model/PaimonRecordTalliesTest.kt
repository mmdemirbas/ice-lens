...
class PaimonRecordTalliesTest {
    ...
    private val fixtures = listOf("test", "dv", "cl", "tg", "pt", "ao", "br", "cs", "fi", "ep", "rt", "sm", "se", "de", "lk", "ad", "px", "pxa", "pc")
    ...
    fun `every recorded record count agrees with the manifests`() {
        ...
        // The corpus yields 102 comparisons; the bound is under that so adding a fixture does not
