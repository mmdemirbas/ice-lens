...
class SnapshotChangeTest {
    ...
    private val fixtures = listOf("test", "parted", "mor", "eqdel", "v3", "evolved", "respec", "branched", "expired", "maint", "v1", "extdata", "sorted", "promoted", "lineage", "pstats", "wap", "rolled", "retained")
