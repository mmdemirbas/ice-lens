...
class LayoutOverlapTest {
    ...
    fun `no two nodes in one column overlap, whatever their kinds`() {
        val icebergFixtures = listOf("test", "parted", "mor", "eqdel", "v3", "evolved", "respec", "branched", "stats", "branched3", "expired", "maint", "v1", "extdata", "sorted", "promoted", "lineage", "pstats", "wap", "rolled")
