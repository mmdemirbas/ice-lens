...
class LayoutOverlapTest {
    ...
    fun `no two nodes in one column overlap, whatever their kinds`() {
        val icebergFixtures = listOf("test", "parted", "mor", "eqdel", "v3", "evolved", "respec", "branched", "stats", "branched3", "expired", "maint", "v1", "extdata", "sorted")
        val paimonFixtures = listOf("test", "dv", "cl", "tg", "pt", "ao", "br", "cs", "fi", "ep", "rt", "sm")
