...
- One click checks every figure the metadata records against the same figure counted — manifest counts and lengths, commit summaries, snapshot totals, Paimon record counts, each file's partition against its own bounds — over the whole table
